...
<div class="mt-4 ml-[210px]">
    ...
    <div class="grid grid-cols-3 gap-6 mt-8">
        ...
        @foreach($praktikum as $item)
            <a href="{{ route('mahasiswa.praktikum.show', $item->id_praktikum) }}" class="block rounded-2xl bg-[#586ce0] text-white p-6 hover:shadow-lg hover:-translate-y-1 transition">
