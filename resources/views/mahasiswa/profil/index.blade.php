        ...
        <div class="flex justify-between items-start">
            <div class="flex items-center gap-5">
                ...
                <div class="w-20 h-20 rounded-full bg-gray-300 overflow-hidden border flex items-center justify-center">
                    <img src="https://i.pinimg.com/736x/2b/bb/5e/2bbb5e6059727209596bfeb5bd1360ea.jpg" alt="" class="w-full h-full object-cover">
                </div>
                {{-- IDENTITAS --}}
                <div>
            ...
            <div class="grid grid-cols-2 gap-12">
                ...
                <div class="space-y-5">
                    ...
                    <div class="flex">
                        ...
                        <p class="text-sm">
                            : {{ $user->birth_place }}, {{ \Carbon\Carbon::parse($user->birth_date)->translatedFormat('d F Y') }}
                        </p>
            ...
            <div class="flex gap-14">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="w-40 h-40 rounded-2xl bg-gray-300 overflow-hidden mb-6">
                        <img src="https://i.pinimg.com/736x/2b/bb/5e/2bbb5e6059727209596bfeb5bd1360ea.jpg" class="w-full h-full object-cover">
                    </div>
